        ...
        <div className="absolute w-[800px] h-[500px] bg-white top-0 ">
            <div className="mt-[10px] ml-[40px]">
                ...
                <div className="flex items-center">
                    <Image src="/botan.png" alt="" width={250} height={250} className="rounded-full border-4 border-black" />
                    <div className="ml-[30px] ">
                        <p className="text-[30px]">Name: Dmytro</p>
                        <p className="text-[30px]">Surname: Hodor</p>
                    </div>
                </div>
