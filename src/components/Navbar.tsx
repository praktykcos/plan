...
const Navbar = () => {
    ...
    return (
        <nav className="block">
            <div className="w-[345px] h-[1250px] bg-[#4CBC9A]">
                <div className="flex items-center text-[36px] font-bold pt-[50px] ml-[46px]">
                    <a href="/">
                        <Image src="/logo.png" alt="" width={50} height={50} className="rounded-[10px] cursor-pointer" />
                    </a>
                        ...
                        return (
                            ...
                            >
                                <Image
                                    ...
                                    width={35}
                                    height={35}
                                    className={`mr-[24px] transition-all duration-300`}
                                />
